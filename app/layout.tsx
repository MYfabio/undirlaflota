...
const META: Record<Lang, { title: string; description: string; og: string }> = {
  ...
  es: {
    title: `${APP_NAME} · La guerra submarina en 3D`,
  ...
  en: {
    title: `${APP_NAME} · Submarine warfare in 3D`,
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: m.title, description: m.og, images: ["/images/hero.png"], locale: lang === "ca" ? "ca_ES" : lang === "es" ? "es_ES" : "en_GB", type: "website" },
